...
#include <memory>
#include "../../../../../ShareCode/Communication/Communication.h"
...
QT_MOC_LITERAL(1, 14, 16), // "SendMsgToManager"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 4), // "code"
QT_MOC_LITERAL(4, 37, 3) // "msg"

    },
    "Communication\0SendMsgToManager\0\0code\0"
    "msg"
};
...
void Communication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendMsgToManager((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QVariant(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Communication::*)(int , const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communication::SendMsgToManager)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Communication::SendMsgToManager(int _t1, const QVariant & _t2)
{
